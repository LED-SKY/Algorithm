 ...
 * <p>
 * 问题 9
 * 一只小猴买了若干个桃子。第一天他刚好吃了这些桃子的一半，又贪嘴多吃了一个；第二天他也刚好吃了剩余桃子的一半，贪嘴多吃了一个；
 * 第三天他又刚好吃了剩下的桃子的一半，并贪嘴多吃了一个。第四天起来一看，发现桃子只剩下一个了。请问小猴买了几个桃子？
 * <p>
 * 问题 10
 * 洛谷的评测任务是单位时间内均匀增加的。8 台评测机 30 分钟可以刚好把评测队列中的程序评测完毕，
 * 10 台评测机 6 分钟可以刚好把评测队列中的程序评测完毕，请问几台评测机可以在 10 分钟时刚好把评测队列中的程序评测完毕？
 * <p>
 * 问题 11
 ...
 * <p>
 * 问题 13
 * 小 A 有两块球形橡皮泥，一个半径是 4，一个半径是 10。他想把这两块橡皮泥揉在一起，然后塑造成一个正方体，
 * 请问这个正方体的棱长是多少？如果结果不是整数，则舍去小数点之后的数字。取 \pi = 3.141593π=3.141593。
 * <p>
 * 问题 14
 * 根据咕咕网校的预测，当课程定价为 110 元时，会有 10 人报名。如果课程价格每降低 1 元，就会多 1 名报名者（反之亦然）。
 * 如果希望总共能收到 3500 元学费的话，那么应该定价多少呢？已知本题有两个答案符合要求，则取较小的那一个。如果这个答案不是整数，则需四舍五入精确到整数。
 **/
public class SolveMultipleProblems {
    public static void main(String[] args) {
        ...
        switch (choose) {
            ...
            case 2:
                ...
                break;
            case 3:
                System.out.println((14 / 4) + " " + (14 - 14 % 4) + " " + (14 % 4));
                break;
            case 4:
                System.out.println((float) (500 / 3));
                break;
            case 5:
            ...
            case 7:
                ...
                System.out.println(money + 10 - 20);
            ...
            case 8:
                ...
                break;
            case 9:
                int sum = ((((((1 + 1) * 2 + 1) * 2) + 1) * 2));
                System.out.println(sum);
                break;
            case 10:
                int unitTimeTask = (30*8-6*10)/(30-10);
